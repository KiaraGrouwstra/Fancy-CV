...
\section{about}
  ...
  % functional: \href{https://github.com/KiaraGrouwstra?tab=repositories\&language=haskell}{Haskell}, \href{https://github.com/KiaraGrouwstra?tab=repositories\&language=scala}{Scala}, \href{https://github.com/KiaraGrouwstra?tab=repositories\&language=elixir}{Elixir}
  ...
  % \href{https://powerpivotpro.com/2014/02/optimal-set-selection-power-pivot-does-pokemon-and-my-brain-just-exploded/}{BI} (\href{https://github.com/KiaraGrouwstra/pquery}{MS})
  % C#,
  ...
  % Erlang,
  % markup: \href{https://github.com/KiaraGrouwstra?tab=repositories\&language=html}{html}/\href{https://github.com/KiaraGrouwstra?tab=repositories\&language=css}{css}, \href{#}{\LaTeX}, markdown
\end{aside}
...
\entry
    ...
    {data engineer}
    {
      productionized cloud-based data warehouse using Spark/Azure, prep for \href{https://www.eugdpr.org/}{GDPR}, coached junior data engineers and data scientists
    }
% \entry
%     {2017–2018}
...
%     % {implemented entity recognition / schema verification, bridged gap between developers and interface designers, outlined incorporating AI in chat bots}
%     {implemented entity recognition, bridged dev/UX teams, outlined incorporating AI in chat bots}
\entry
    {2014–2017}
    {TGS Holdings}
    {lead software engineer}
    {led various full-stack and hybrid mobile dev projects (TS/Rails/AWS)}
% \entry
%     {2014–2015}
...
%     {automated reporting for QC services, hired/trained freelancers} %, web dev
\entry
    {2012–2013}
...
%     {}
  ...
  %   {\href{https://openreview.net/forum?id=DJ1Bc526-y9}{openreview.net/forum?id=DJ1Bc526-y9}}
     {
